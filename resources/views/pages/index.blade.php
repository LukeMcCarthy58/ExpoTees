...
@section('content')
    ...
    <a href="https://www.tees.ac.uk/expotees/" target="_blank"><img class="mx-auto d-block" style="width: 150px; height:150px;" src="https://expotees-images.s3.eu-west-2.amazonaws.com/images/expotees.png" alt="Logo"></a>
